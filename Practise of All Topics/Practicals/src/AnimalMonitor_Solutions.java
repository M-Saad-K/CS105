 ...
 */
public class AnimalMonitor_Solutions
{
     ...
     */
    public AnimalMonitor_Solutions()
    {
    ...
    public void printAnimals()
    {
        ...
        sightings.forEach(sighting -> System.out.println(sighting.getAnimal()));
    }
    ...
    public void printSpotterSightingsCount(int spotter) {
        sightings.stream()
    ...
    public int getDayCount(String animal, int spotterID, int dayID)
    {
